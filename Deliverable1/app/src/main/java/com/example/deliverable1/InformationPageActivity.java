...
public class InformationPageActivity extends AppCompatActivity {
                ...
                regReference.child("Patients").child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            Intent intent = new Intent(InformationPageActivity.this, InboxPageActivity.class);
    ...
    public void onClickInboxList(View view){
        Intent intent = new Intent(InformationPageActivity.this, InboxPageActivity.class);
        startActivity(intent);
    }

    private void sendEmailToApprovedUser(String email) {
        EmailIntentBuilder.from(this)
                .to(email)
                .subject("Patient Registration Approved")
                .body("Your patient registration has been approved.")
                .start();
    }

    private void sendEmailToRejectedUser(String email) {
        EmailIntentBuilder.from(this)
                .to(email)
