...
public class rejectItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.reject_item_page);
    ...
    private void updateListView() {
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(rejectItemActivity.this, rejectItemInfoActivity.class);
